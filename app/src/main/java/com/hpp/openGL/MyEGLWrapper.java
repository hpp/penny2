...
public class MyEGLWrapper {
    ...
    private void eglSetup() {
        ...
        // Assumes the surface is already attached to current draw surface. But this is the surfaced used to write to mux
        //EGLSurface mCurrentSurface = EGL14.eglGetCurrentSurface(EGL14.EGL_READ);


        //if (mCurrentSurface == mEGLSurface) return;
     ...
     * owns the EGLContext). 
     * @param toScreen, if false camera preview, true => recording
